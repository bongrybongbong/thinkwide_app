...
st.header('🫧 {0}님의 마인드맵 둘러보기 💡'.format(name))
st.markdown("""---""")
st.subheader(' **🪐ThinkWide** 프로젝트 가상 회의록.')
st.markdown('**회의 요약 :** ThinkWide의 VR 마인드맵 도구 개발에 초점을 맞추어, 다양한 VR 헤드셋 호환성, 사용자 친화적인 인터페이스 및 컨트롤러 지원, 가상 공간 설계의 최적화, 그리고 마케팅 전략 수립에 대해 토론하고 구체적인 작업 방향을 설정했어요!:sparkles:')
